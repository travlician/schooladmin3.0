...
//
  ...
  function stud_grades($sid,$schoolyear)
  {
    ...
    echo("<font size=+2><center>" . $dtext['gcard_4'] . " " . $student->get_firstname() . " " . $student->get_lastname());
	echo("<br>Klas: ". $_SESSION['CurrentGroup']);
    echo("<br>Schooljaar: " . $schoolyear . "</font><br>"); 
