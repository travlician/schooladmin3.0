...
//
  ...
  echo("<form method=post action=form_PK_invoer_JW2.php ID=groupsel NAME=groupsel>" . $dtext['Group_Cap'] . 
  ...
  echo("<form method=post action=form_PK_invoer_JW2.php ID=subjsel NAME=subjsel>" . $dtext['Subject'] . 
  ...
  echo("<form method=post action=form_PK_invoer_JW2.php ID=persel NAME=persel>" . $dtext['Period'] . 
