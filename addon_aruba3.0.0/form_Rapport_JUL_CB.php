...
//
  ...
  $vakhead["ALL"] = array("ne","en","sp","pa","wi","n&t","pv","asw","ik","ckv","lo","kgl");
  $vakdesc["ALL"] = array("kgl"=>"<B>Kennis van het Geestelijk Leven</B> <i>(Conocemento Spiritual y Religioso)</i>",
  ...
  if(isset($groups))
  {
    ...
    echo '<LINK rel="stylesheet" type="text/css" href="style_Rapport_JUL.css" title="style1">';
	  ...
	  if(isset($students))
	  {
		...
		while ($llnoffset < sizeof($students['sid']))
		{
		  ...
		  echo("<SPAN class=rapdata>". $students['firstname'][1+$llnoffset]. " ". $students['lastname'][1+$llnoffset]. "</SPAN>");
			...
			echo("<TR><TD class=thickfullcenter colspan=5>Ciclo Basico<BR><i>Schooljaar: ". $schoolyear. " <SPAN class=groupname>Klas: ". $groups['groupname'][$gix]. "</SPAN></i></td></tr>");
