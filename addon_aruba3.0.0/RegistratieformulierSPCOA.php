...
//
// Dit inschrijfformulier is gemaakt voor de SPCOA scholen
...
// Koptekst Inschrijfformilier op elke pagina - HOE DOE JE DAT??:
    echo("<html><head><title>Aanmeldingsformulier</title>");
...
//	Nu de tekst en het logo:
	echo("<p class=Koptekst>Aanmeldingsformulier voor  ". $schoolname. " ". $schoolyear."</p>");
//	Gevolgd door het logo:
	...
	echo("<form method=post action=handle_inschrijvingSPCOA.php name=inschrijving id=inschrijving>");
	echo("<input type=hidden name='tablename' value='nieuwe_registratie'>");
	

// PARAGRAAF 1: Kiezen type onderwijs zoalS avond of middag ondewijs, mavo of havo
...
//
	...
	echo("<tr><td class=TekstRechts>eMail van de leerling / eMail di e alumna/o:</td><td class=TekstLinks><input type=text name=EmailAddress size=40></td></tr>");
// Tussenregel:
	echo("<tr colspan=2 class=Tussenregel></tr>");
//
	echo("<tr><td class=TekstRechtsID>Voogd / Verantwoordelijk persoon / Persona cu ta responsabel:</td><td class=TekstLinksID><input type=text name=ResponsPersoon size=60></td></tr>");
	echo("<tr><td class=TekstRechts>Telefoon indien noodgeval / Telefon di emergencia:</td><td class=TekstLinks><input type=text name=EmergPhoneNr size=7></td></tr>");
...
// EstCivilFamily; RelegionFamily; HomeMD; FamilyForm; Botica
	...
	echo("<tr><td class=TekstRechts>Burgelijke staat ouders / Estado civil mayornan:</td><td class=TekstLinks><select name=EstCivilFamily><option value=''></option><option value=Gehuwd>gehuwd / casa</option><option value=Ongehuwd>ongehuwd / no casa</option><option value=Gescheiden>gescheiden / divorsia</option><option value=Weduwe>Weduw(e)(naar) / Biud(a)(o)</option><option value=Samenwonend>Samenwonend</option></select></td></tr>");
	echo("<tr><td class=TekstRechts>Religie / Religion:</td><td class=TekstLinks>");
	$countrylist = SA_loadquery("SELECT * FROM arubacom.c_religion ORDER BY tekst");
	...
	echo("<tr><td colspan=2 class=TekstRechtsID>Vermeld alleen broers of zussen op SPCOA scholen / Menciona ruman cu ta bay SPCOA scol so</td></tr>");
	echo("<tr><td class=TekstRechts>Naam broer of zus / Nomber di ruman 1:</td><td class=TekstLinks><input type=text name=NameBroSis1 size=25></td></tr>");
	echo("<tr><td class=TekstRechts>Naam broer of zus / Nomber di ruman 2:</td><td class=TekstLinks><input type=text name=NameBroSis2 size=25></td></tr>");
	echo("<tr><td class=TekstRechts>Naam broer of zus / Nomber di ruman 3:</td><td class=TekstLinks><input type=text name=NameBroSis3 size=25></td></tr>");
	echo("<tr><td class=TekstRechts>Naam broer of zus / Nomber di ruman 4:</td><td class=TekstLinks><input type=text name=NameBroSis4 size=25></td></tr>");
	echo("</table><br>");
	...
	switch ($schoolname)
	{
		...
		case "Test LVS":
			...
			echo("<tr><td class=TekstRechtsID rowspan=8>Bij inschrijving meenemen:<br>Alumno mester bin cu:</td>
				<td class=TekstLinksID><i>&#9745;&nbsp;Ricibo&nbsp;di&nbsp;pago&nbsp;di&nbsp;schoolgeld&nbsp;/&nbsp;re&ccedil;u</i></td></tr>");
			echo("<tr><td class=TekstLinksID><i>&#9745;&nbsp;Ricibodi&nbsp;pago&nbsp;di&nbsp;airco&nbsp;/&nbsp;re&ccedil;u</i></td></tr>");
