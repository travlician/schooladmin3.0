...
*/		  
		  ...
		  echo("</DIV>");		  
		  echo("<P class=resultrap>Datum: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_________________</P>");
		  ...
		  echo("<DIV class=rapblock>Opmerking:<BR>");
			if(isset($rapopms[$students['sid'][$llnoffset+1]][1]))
				...
				echo("<DIV class=remarks>&nbsp;<HR>&nbsp;<HR>&nbsp;<HR></DIV>");
		  ...
		  echo("o Over naar <B>Ciclo Avansa 4</B><BR>");
		  echo("&nbsp;&nbsp;&nbsp;&nbsp;Profielkeuze:<SPAN class=referitem>o MM &nbsp;o NW &nbsp;o HU</SPAN><BR>");
		  echo("<BR><BR><BR>&nbsp;&nbsp;&nbsp;&nbsp;Keuze vakken:<SPAN class=referitem>_____________</SPAN>");
