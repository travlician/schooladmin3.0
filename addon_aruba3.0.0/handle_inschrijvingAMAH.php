<?
 ...
 // $login_qualify = 'ACT';
  ...
  {
    echo("<p class=FoutMelding>Cedulanummer is niet correct, ga <a href=RegistratieformulierAMAH.php> <font color=blue><u>terug naar het inschrijfformulier</u></font> </a>en vul alles opnieuw in!</p>");
	exit;
  }
  
  // If birthdate is left as default, change it to blanks
  if(isset($_POST['Bday']) && $_POST['Bday'] == 1 && isset($_POST['Bmonth']) && $_POST['Bmonth'] == 1 && isset($_POST['Byear']) && $_POST['Byear'] == '1968')
  {
    $_POST['Bday'] = '';
	$_POST['Bmonth'] = '';
	$_POST['Byear'] = '';
 ...
 /* 
  // Debugging, show all fields posted!
...
*/	
  ...
  if(!isset($existstable))
  {
	...
	$createq .= "`lastmodifiedat` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  if(isset($existscedula))
  {
	...
	{ // Same person, update data that is not blank
      ...
      echo("<p class=FoutMelding>Cedulanummer is al gebruikt, ga <a href=RegistratieformulierAMAH.php> <font color=blue><u>terug naar het inschrijfformulier</u></font> </a>en vul alles opnieuw in!</p>
