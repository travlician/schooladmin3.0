...
//
  ...
  $vakhead["ALL"] = array("Ne","En","Sp","Pa","Wi","N&T","Pv","Asw","Rek","Ik","Ckv","Lo","Kgl");
  ...
  $afwezigreden = array(1,2,3,4,5,11,12);
  ...
  if(isset($groups))
  {
    ...
    echo '<LINK rel="stylesheet" type="text/css" href="style_Rapport_MC.css" title="style1">';
