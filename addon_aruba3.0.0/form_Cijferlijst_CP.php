...
| NW01        | wiA,en,bio,lo,ne,skBB,naBB |
| NW02        | wiA,en,bio,sp,lo,ne,skBB   |
| NW03        | wiA,ec,en,bio,lo,ne,skBB   |
| NW04        | wiA,m&o,en,bio,lo,ne,skBB  |
| NW05        | en,bio,lo,wiB,ne,skBB,naBB |
| NW06        | en,bio,sp,lo,wiB,ne,skBB   |
| NW07        | en,sp,lo,wiB,ne,skBB,naBB  |
| NW08        | en,bio,sp,lo,wiB,ne,skBB   |
| NW09        | wiA,en,sp,lo,ne,skBB,naBB  |
| NW10        | wiA,ec,en,lo,ne,skBB,naBB  |
| NW11        | m&o,en,lo,wiB,ne,skBB,naBB |
| NW12        | ec,en,lo,wiB,ne,skBB,naBB  |
| NW13        | wiA,en,bio,lo,pap,ne,skBB  |
| NW14        | wiA,en,bio,lo,pap,ne,skBB  |
| NW15        | en,lo,pap,wiB,ne,skBB,naBB | */
  ...
  $pksubs['NW01'] = array('ne','en','wiA','naBB','skBB','bio');
  $pksubs['NW02'] = array('ne','en','wiA','skBB','bio','sp');
  $pksubs['NW03'] = array('ne','en','wiA','skBB','bio','ec');
  $pksubs['NW04'] = array('ne','en','wiA','skBB','bio','m&o');
  $pksubs['NW05'] = array('ne','en','wiB','naBB','skBB','bio');
  $pksubs['NW06'] = array('ne','en','wiB','skBB','bio','sp');
  $pksubs['NW07'] = array('ne','en','wiB','naBB','skBB','sp');
  $pksubs['NW08'] = array('ne','en','wiB','skBB','bio','sp');
  $pksubs['NW09'] = array('ne','en','wiA','naBB','skBB','sp');
  $pksubs['NW10'] = array('ne','en','wiA','naBB','skBB','ec');
  $pksubs['NW11'] = array('ne','en','wiB','naBB','skBB','m&o');
  $pksubs['NW12'] = array('ne','en','wiB','naBB','skBB','ec');
  $pksubs['NW13'] = array('ne','en','wiA','skBB','bio','pap');
  $pksubs['NW14'] = array('ne','en','wiA','skBB','bio','pap');
  $pksubs['NW15'] = array('ne','en','wiB','naBB','skBB','pap');
  ...
  $sub2full = array("ne"=>"Nederlandse taal en literatuur", "en"=>"Engelse taal en literatuur", "wiA"=>"Wiskunde A",
					...
					"ec"=>"Economie", "m&o"=>"Management en organisatie", "skBB"=>"Scheikunde", "naBB"=>"Natuurkunde",
					"wiB"=>"Wiskunde B", "bio"=>"Biologie","CKV"=>"Culturele en kunstzinnige vorming","pap"=>"Papiamentse taal en cultuur");
