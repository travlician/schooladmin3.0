...
//
  ...
  $vakhead["Maatschappij"] = array("Asw","asw-ak","asw-ec","asw-gs");
  $vakhead["Taal & Communicatie"] = array("Pa","Ne","En","Sp");
//  $vakhead["Kunst & Cultuur"] = array("Dr","Mu","Ckv");
  $vakhead["Kunst & Cultuur"] = array("Vo");
    ...
    foreach($groups['gid'] AS $gix => $gid)
	{
	  ...
	  if(isset($students))
	  {
		...
		while ($llnoffset < sizeof($students['sid']))
		{
		  ...
		  echo("<TR><TH class=headleft COLSPAN=2>SKOA norm</TH>");
		  for($sx = 1; $sx <= $scnt; $sx++)
		  {
		    for($p=0;$p<4;$p++)
			{
		  ...
		  echo("</TABLE>");
		  echo("<P class=footer>SKOA norm: HV=HAVO, BV=Bevorderen, BE=Bespreekgeval, DB=Doubleren, EPB=Verwijzing EPB</P>");
