<?
 ...
 // $login_qualify = 'ACT';
  ...
  {
    echo("<p class=FoutMelding>Cedulanummer is niet correct, ga <a href=RegistratieformulierMavoBO.php> <font color=blue><u>terug naar het inschrijfformulier</u></font> </a>en vul alles opnieuw in!</p>");
	  exit;
  }
  ...
  if(isset($existscedula))
  {
	...
	{ // Same person, update data that is not blank
	  ...
	  if(mysql_error())
	  {
		...
		echo("<p class=Koptekst>Dank u voor het invullen van de gegevens, deze zijn nu toegevoegd of aangepast ten opzichte van de eerder verstrekte gegevens.</p>");
		echo("<p class=Koptekst>Danki pa yena e datonan, awor nan a wordo agrega of adapta.</p>");
	}
	else
      echo("<p class=FoutMelding>Cedulanummer is al gebruikt, ga <a href=RegistratieformulierMavoBO.php> <font color=blue><u>terug naar het inschrijfformulier</u></font> </a>en vul alles opnieuw in!</p>
