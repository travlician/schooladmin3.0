...
//
  ...
  $subjlinks = array("@NEDERLANDSE TAAL" => "ne", "Dictee" => "dc", "Taaloefeningen" => "to", "Tekst/Begr. Lezen" => "tk","-endnl" => "",
                     "*LEZEN (technisch)" => "le", "AVI-niveau" => "avi", "-endle" => "",
...
//	De opmaak van de "minitabel rechtsboven:
		echo("<div class = rechtsboven> <table class = minitabel>
											...
											<tr><td>S.P.C.O.A. nr.: ". $student->get_student_detail("ASSPCOANumber"). "</td></tr>
