...
//
  ...
  echo("<P class=maintitle>CIJFERLIJST</p>");
	...
	// Signoff area
	echo("<P class=leftsign>Drs. M.A. van Loon<BR>(voorzitter examencommissie)</p>");
	echo("<P class=rightsign>Drs. N.L.M. Boekhouder-Wever<BR>(secretaris examencommissie)</p>");
