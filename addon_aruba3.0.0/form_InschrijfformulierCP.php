...
// ResponsePersoon; EmergPhoneNr; InArubaSince; LiveAt;
	...
	//
		...
		echo("<tr><td class=TekstRechts>Mobiel leerling / cellular di e mucha:</td><td class=TekstLinks>");
		  ...
		  $field->echo_html();
		echo("</td></tr>");
		echo("<tr><td class=TekstRechts>e-mail adres van de leerling / e-mail adres di e alumno:</td><td class=TekstLinks>");
	...
	//
		echo("<tr><td class=TekstRechtsID>Voogd / Verantwoordelijk persoon / Persona cu ta responsabel:</td><td class=TekstLinksID>");
		  ...
		  $field->echo_html();
		echo("</td></tr>");
		echo("<tr><td class=TekstRechts>Telefoon in geval van nood / Telefon di emergencia:</td><td class=TekstLinks>");
	...
	// LastnameDad; FirstnameDad; AddressDad; DistrictDad; PhoneHomeDad; MobilePhoneDad; EmailAddressDad; ProfesionDad; CompagnyNameDad; PhoneCompagnyDad;
		...
		echo("<tr><td class=TekstRechts>Mobiel / cellular:</td><td class=TekstLinks>");
		  ...
		  $field->echo_html();
		echo("</td></tr>");
		echo("<tr><td class=TekstRechts>e-mail adres:</td><td class=TekstLinks>");
	...
	// EstCivilFamily; RelegionFamily; HomeMD; FamilyForm; Botica
		...
		echo("<tr><td class=TekstRechts>Burgerlijke staat ouders / Estado civil mayornan:</td><td class=TekstLinks>");
	...
	// PARAGRAAF 8: geen velden
		...
		switch ($schoolname)
		{
			...
			case "Filomena College MAVO":
				...
				$field->echo_html();
				echo("&nbsp;Ricibo di pago di schoolgeld</i></td></tr>");
				...
				$field->echo_html();
				echo("&nbsp;Ricibo di pago di boekengeld</i></td></tr>");
				echo("<tr><td class=TekstLinks><i>");
		...
		echo("</table>");
		//echo("</form>");
		echo("<p class=Opgelet>Voordat je het formulier verstuurt, controleer alle informatie!<br></p>");
