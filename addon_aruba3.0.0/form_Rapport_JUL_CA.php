...
//
  ...
  $vakhead["ALL"] = array("ne","en","sp","pa","wi","na","sk","bi","ec","ak","gs","ik","ckv","lo");
  $vakdesc["ALL"] = array("pv"=>"<B>Persoonlijke vorming</B> <i>(Formacion Personal)</i>",
						  ...
						  "bi"=>"<B>Biologie</B> <i>(Biologia)</i>",
						  "ec"=>"<B>Ecomomie en Management & Organisatie</B> <i>(Economia y Maneho & Organisacion)</i>");
