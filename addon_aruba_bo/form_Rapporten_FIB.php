<?php
  ...
  $mainsubjects = array( 1 => "VERKEER", "ENGELS", "SPAANS", (substr($CurrentGroup,0,1) != 3 ? "LICHAMELIJKE OPVOEDING" : "ZWEMNIVEAU"), "HANDVAARDIGHEID", "TEKENEN", "MUZIKALE VORMING",
                              "GODSDIENST", "NEDERLANDSE TAAL", "LEZEN", "REKENEN", "SCHRIJVEN", "AARDRIJKSKUNDE", "GESCHIEDENIS", "KENNIS DER NATUUR", "MAATSCHAPPIJLEER", "AVI-NIVEAU");
  $mainsubjectabbrevs = array( 1 => "Verkeer","EN","Spa","LO","HV","Tekenen","Muziek","Godsd","Ned","Lez","Rek","Schr","AK","Gesch","KdN","Maats.L","Avi");
	if(substr($CurrentGroup,0,1) == 1)
	{
		$subsubjects["Ned"] = array(1 => "&nbsp;&nbsp;&nbsp;<i>Dictee</i>", "&nbsp;&nbsp;&nbsp;<i>Woordenschat</i>", "&nbsp;&nbsp;&nbsp;<i>Taaloefeningen</i>","&nbsp;&nbsp;&nbsp;<i>Tekst</i>");
		//$subsubjectabbrevs["Ned"] = array(1 => "Dictee","Taal oe","Taal ve","Tekst");
		$subsubjectabbrevs["Ned"] = array(1 => "Dictee","Woord s","Taal oe","Tekst");
	}
	else
	{
  ...
  */
  ...
  echo(">");
  echo '<LINK rel="stylesheet" type="text/css" href="fibrapport.css" title="style1">';
  ...
  foreach($student_array['sid'] AS $si => $sidx)
  {
	...
	echo("<DIV class=schoolinfo>Colegio Santa Filomena<BR>Weg Seroe Preto 2<BR>San Nicolas, Aruba<BR>Tel.: 584-5802<BR>&nbsp;</DIV>");
...
/*	echo("</TR>");
	...
	echo("<TR><TD>Hoofd:</TD><TD>M. Nooijen</TD><TD>________________________________________</TD></TR>");
  ...
  function show_subject($sbix, $noformat = false)
  {
  ...
  function show_result($res,$noformat = false)
  {
		if($noformat)
			show_result_a($res);
		else
