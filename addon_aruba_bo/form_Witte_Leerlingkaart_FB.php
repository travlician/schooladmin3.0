...
//
  ...
  $subjlinks = array("@NEDERLANDSE TAAL" => "Nederlands", "Dictee" => "Dictee", "Woordenschat" => "Woordenschat", "Taaloefeningen" => "Taal oefeningen","Taal verkennen" => "Taal verkennen", "Tekst" => "Tekst","-endnl" => "",
                     "*LEZEN (technisch)" => "Lezen", "AVI-niveau" => "Avi-lezen", "Begrijpend" => "Begr. Lezen", "-endle" => "",
					 "*REKENEN" => "Rekenen", "Minimum toets" => "Minimum Toets", "Project Toets" => "Project Toets", "Basis Toets" => "Basis Toets", "Getallen/bewerking" => "GB", "Hoofdbewerkingen" => "HBW",
					 "Allerlei" => "AL", "-endre" => "",
					 "*AARDRIJKSKUNDE" => "Aardrijkskunde", "*GESCHIEDENIS" => "Geschiedenis", "*KENNIS DER NATUUR" => "Natuniek", "-endmain" => "",
					 "@Godsdienst" => "Godsdienst", "Schrijven" => "Schrijven", "Verkeer" => "Verkeer", "Engels" => "Engels", "Spaans" => "Spaans", "Papiamento" => "pa", 
					 "Bewegingsonderwijs" => "Lich. Opvoeding", "Handvaardigheid" => "Handv.", "Tekenen" => "Tekenen", "Muziek" => "Muziek", "-endall" => "");
