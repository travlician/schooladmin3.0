<?php
  ...
  */
  ...
  foreach($student_array['sid'] AS $si => $sidx)
  {
	...
	echo("<DIV class=schoolinfo>Colegio Frère Bonifacius<BR>Gutenbergstraat 6<BR>Tel.: 583-7128<BR>e-mail: cfbdirectie@icloud.com<BR>&nbsp;</DIV>");
...
/*	echo("</TR>");
	...
	IF($curperiod == 1 && $schoolyear=='2016-2017')
		echo("<TR><TD>Wnd. hoofd:</TD><TD>Derek Peterson</TD><TD>________________________________________</TD></TR>");
	else
