...
//
  ...
  $defcntqr = SA_loadquery("SELECT DISTINCT categorie AS defcat FROM bo_houding_defs");
  ...
  $defcatqr = SA_loadquery("SELECT DISTINCT categorie AS defcat FROM bo_houding_defs");
  ...
  echo("1 is het slechtse, 5 is het beste resultaat.");
