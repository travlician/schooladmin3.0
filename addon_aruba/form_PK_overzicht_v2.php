...
//
  ...
  echo("<form method=post action=form_PK_overzicht_v2.php ID=groupsel NAME=groupsel>" . $dtext['Group_Cap'] . 
...
/*  echo("<form method=post action=form_PK_overzicht_v2.php ID=subjsel NAME=subjsel>" . $dtext['Subject'] . 
  ...
  echo("<form method=post action=form_PK_overzicht_v2.php ID=persel NAME=persel>" . $dtext['Period'] . 
...
/*  echo("<tr><td><center>Leerling</td>");
  ...
  foreach($students AS $stobj)
  {
   if(isset($stobj))
   {
	...
	{
	  echo("<TD class=per". $CurrentPer. ">". (isset($hdata[$sid][$aspix]["G"]) ? $hdata[$sid][$aspix]["G"] : " "). "</td>");
	  ...
	  echo("<TD class=per". $CurrentPer. ">". (isset($hdata[$sid][$aspix]["S"]) ? $hdata[$sid][$aspix]["S"] : " "). "</td>");
	}
	echo("</tr>");
   }
  }
