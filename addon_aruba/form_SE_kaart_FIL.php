...
// 	Paragraaf SO uitslag:
	...
	$sogpass = (($sogminp < 2 || ($sogminp == 2 && $sogcomp >= 2)) && (isset($ckvres['ckvres']) && $ckvres['ckvres'][0] == 1) && (isset($averages[$subj2mid[$subjseq[$package][2]]][2] || isset($vrijst[$subj2mid[$subjseq[$package][2]]]) && $averages[$subj2mid[$subjseq[$package][2]]][2] > 5.4));
