  ...
  if(isset($groups))
 {
    ...
    foreach ($KlasLijst AS $group)
		{
			...
			echo("<TR class=toprow><th>klas</th><th>nr.</th><th>naam</th><th>voornaam</th><th>v/m</th><th>". ($idcol == "s_ASIdNr" ? "Censo id" : "Id."). "</th><th>huisadres*</th><th>voertaal</th><th>geb.</th><th>instr.</th><th>vader/voogd</th><th>moeder/voogd</th></tr>");
  ...
  echo("</html>");
	function format_idnr($idnr)
	{
		...
		$idtxt = str_pad($idnr,8,'0',STR_PAD_RIGHT);
