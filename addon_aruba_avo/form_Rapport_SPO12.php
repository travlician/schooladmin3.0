...
//
  ...
  $vakhead["Dominio di Idioma"] = array("Pa","En","Ne");
	    ...
	    $llnoffset = 0;
			while ($llnoffset < sizeof($students['sid']))
			{
				...
				for($sx = 1; $sx <= $scnt; $sx++)
				{
					...
					<td rowspan=4 class=greybgcenter>1<sup>e</sup><BR><BR>r<BR>a<BR>p<BR>o<BR>r<BR>t</td><td class=sepcolw></td>
					<td rowspan=4 class=greybgcenter>2<sup>o</sup><BR><BR>r<BR>a<BR>p<BR>o<BR>r<BR>t</td><td class=sepcolw></td>
					<td rowspan=4 class=greybgcenter>3<sup>er</sup><BR><BR>r<BR>a<BR>p<BR>o<BR>r<BR>t</td><td class=sepcolw></td>
					<td rowspan=4 class=greybgcenter>ultimo</sup><BR><BR>r<BR>a<BR>p<BR>o<BR>r<BR>t</td></tr>
