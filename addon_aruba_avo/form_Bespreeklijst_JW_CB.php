...
//
  ...
  $vakhead["Maatschappij"] = array("asw","ASWcb2","asw-asw","ec-ASW");
  $vakhead["Taal & Communicatie"] = array("pa","Ned-CB","Ned-cb1","Ned-cb2","ws","en","sp");
  $vakhead["Kunst & Cultuur"] = array("da","bv","mu","th","ckv");
  $vakhead["Natuur"] = array("n&t");
  $vakhead["Wiskunde"] = array("wi/rek","wiCB","rek");
  $vakhead["Onderw. Onderst."] = array("ik");
  $newan = array("ne","en","wi","asw","n&t");
  $ptvakken = array("kgl","pv","lo","asw","ASWcb2","pa","Ned-CB","en","sp","ckv","n&t","wis/rek","ik");
