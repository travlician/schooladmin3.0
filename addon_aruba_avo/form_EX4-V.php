...
//
  ...
  $altsubjects = array("Ne"=>1,"En"=>2,"I&S"=>3,"Sp"=>4,"Wi-A"=>5,"Wi-B"=>6,"Na"=>7,"Sk"=>8,"Bio"=>9,"Ec"=>10,"M&O"=>11,"Ak"=>12,"Gs"=>13,"Pfw"=>14,"CKV"=>15,
                       "ne"=>1,"en"=>2,"i&s"=>3,"sp"=>4,"wiA"=>5,"wiB"=>6,"na"=>7,"sk"=>8,"bio"=>9,"ec"=>10,"m&o"=>11,"ak"=>12,"gs"=>13,"pfw"=>14,"ckv"=>15);
  ...
  $squery .= " LEFT JOIN s_exnr USING(sid) WHERE active=1 AND s_exnr.data IS NOT NULL AND s_exnr.data > '0' AND groupname='ExamVwo' ORDER BY s_exnr.data";
