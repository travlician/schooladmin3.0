...
//
  ...
  function print_head($subjecttext, $scount)
  {
    ...
    echo("EXAMEN HAVO/VWO, schooljaar <b>". $schoolyear. "</b><BR>");
...
{ // No print posted, must show filter and sort fields
  $presenceoptions = array(1 => "Her","Afw. Mo","Afw. SE","Afw. Ex","Vrijst. 7","Vrijst. 8","Vrijst. 9","Vrijst. 10","Cert. 6","Cert. 7","Cert. 8","Cert. 9","Cert. 10","Beh. 1","Beh. 2","Beh. 3","Beh. 4","Beh. 5","Beh. 6","Beh. 7","Beh. 8","Beh. 9","Beh. 10");
  $teacher = SA_loadquery("SELECT tid,firstname,lastname FROM teacher WHERE is_gone <> 'Y'");
  SA_closeDB();

  // First part of the page
  echo("<html><head><title>Formulier EX. 3-HV</title></head><body link=blue vlink=blue bgcolor=#FFFFE0>");
  echo '<LINK rel="stylesheet" type="text/css" href="style_sop.css" title="style1">';
  ...
  echo("<FORM METHOD=POST ACTION='form_EX3-HV.php'>");
