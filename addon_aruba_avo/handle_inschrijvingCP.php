<?
 ...
 // $login_qualify = 'ACT';
  ...
  {
    echo("<p class=FoutMelding>Cedulanummer is niet correct, ga <a href=RegistratieformulierCP.php> <font color=blue><u>terug naar het inschrijfformulier</u></font> </a>en vul alles opnieuw in!</p>");
	  exit;
  }
  ...
  if(isset($existscedula))
  {
	...
	{ // Same person, update data that is not blank
      ...
      echo("<p class=FoutMelding>Cedulanummer is al gebruikt, ga <a href=RegistratieformulierCP.php> <font color=blue><u>terug naar het inschrijfformulier</u></font> </a>en vul alles opnieuw in!</p>
