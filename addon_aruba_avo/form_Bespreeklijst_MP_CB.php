...
//
  ...
  $ptvakken = array("KGL","PV","LO","ASW","PAP","NED","ENG","SPA","CKVB","N&T","WIS","REK","IK");
		...
		while ($llnoffset < sizeof($students['sid']))
		{
		  ...
		  for($sx = 1; $sx <= $scnt; $sx++)
		  {
		    for($p=0;$p<4;$p++)
			{
			  $pi = ($p + 1) % 4;
			  echo("<TD>");
			  if($stcalp[$sx][$pi] >= 100 && $stcalo[$sx][$pi] == 0 && $stcaln[$sx][$pi] >= 40)
			    echo("HV");
			  else if($stcalp[$sx][$pi] >= 78 && $stcalo[$sx][$pi] <= 3 && $stcalc[$sx][$pi] <= 4 && $stcals4[$sx][$p] == 0)
			    echo("MV");
			  else if($stcalp[$sx][$pi] == 78 && $stcalo[$sx][$pi] == 1 && $stcalc[$sx][$pi] == 1)
			    echo("MV");
			  else if($stcalp[$sx][$pi] >= 72 && $stcalp[$sx][$pi] <= 77 && $stcalo[$sx][$pi] <= 4 && $stcalc[$sx][$pi] <= 4 && $stcals5[$sx][$pi] == 0)
			    echo("BES");
			  else if($stcalp[$sx][$pi] < 65 || $stcalt[$sx][$pi] == 6)
			    echo("EPB");
			  else if($stcalp[$sx][$pi] < 72)
			    echo("DOU");
			  else
			  {					
				  echo("?");
