	...
	********************************************************/
	this.useSuggestion = function()
	{
		if (this.highlighted > -1)
		{
			...
			//the event completes.
			setTimeout("document.getElementById('" + this.elem.id + "').focus()",10);
			setTimeout("send_xml('" + this.elem.id + "',document.getElementById('" + this.elem.id + "'))",20);
		}
	};
...
var idCounter = 0;
/***** Force a special DIV be present   */
</SCRIPT>
<div id="autosuggest"><ul></ul></div>
<SCRIPT>
