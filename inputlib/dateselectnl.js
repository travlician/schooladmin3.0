...
function DateChooser()
{
	...
	ndDateChooser.style.position = 'fixed';
	...
	this.display = function(e)
	{
		...
		DisplayDateChooser(objPosition.left + nXOffset + 'px', objPosition.top + nYOffset - window.scrollY + 'px');
